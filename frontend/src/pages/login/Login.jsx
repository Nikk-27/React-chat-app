		...
		<div className='flex flex-col items-center justify-center min-w-96 mx-auto'>
			<div className='w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
				...
				<form onSubmit={handleSubmit}>
					...
					<Link to='/signup' className='text-sm  hover:underline hover:text-blue-600 mt-2 inline-block' style={{ color: 'black' }}>
...
// 						</label>
// 						<input type='text' placeholder='Enter username' style={{ backgroundColor: 'white', color: 'black' }} className='w-full input input-bordered h-10 ' />
// 					</div>
